 ...
 */
export function createChatCompletionApiV1ArbitersChatCompletionsPost(
...
> {
  ...
  const path = pathToFunc("/api/v1/arbiters/chat/completions")();
  ...
  const context = {
    ...
    operationID: "create_chat_completion_api_v1_arbiters_chat_completions_post",
    oAuth2Scopes: null,
