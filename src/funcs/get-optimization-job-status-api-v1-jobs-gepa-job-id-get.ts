...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetOptimizationJobStatusApiV1JobsGepaJobIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/jobs/gepa/{job_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GepaJobResponse$inboundSchema),
