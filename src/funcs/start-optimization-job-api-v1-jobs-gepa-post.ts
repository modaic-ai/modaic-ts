 ...
 */
export function startOptimizationJobApiV1JobsGepaPost(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.GepaJobRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/jobs/gepa")();
  ...
  const context = {
    ...
    operationID: "start_optimization_job_api_v1_jobs_gepa_post",
    oAuth2Scopes: null,
