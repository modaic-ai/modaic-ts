 ...
 */
export function cancelOptimizationJobApiV1JobsGepaJobIdDelete(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CancelOptimizationJobApiV1JobsGepaJobIdDeleteRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "cancel_optimization_job_api_v1_jobs_gepa__job_id__delete",
    oAuth2Scopes: null,
