 ...
 */
export function getBatchPredictionsJobStatusApiV1JobsBatchPredictionsJobIdGet(
...
> {
  ...
  const path = pathToFunc("/api/v1/jobs/batch/predictions/{job_id}")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID:
      "get_batch_predictions_job_status_api_v1_jobs_batch_predictions__job_id__get",
    oAuth2Scopes: null,
