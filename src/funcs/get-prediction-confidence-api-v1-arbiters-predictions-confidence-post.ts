 ...
 */
export function getPredictionConfidenceApiV1ArbitersPredictionsConfidencePost(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.GetConfidenceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/arbiters/predictions/confidence")();
  ...
  const context = {
    ...
    operationID:
      "get_prediction_confidence_api_v1_arbiters_predictions_confidence_post",
    oAuth2Scopes: null,
