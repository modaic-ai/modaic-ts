 ...
 */
export function streamBatchPredictionsEventsApiV1JobsBatchPredictionsJobIdEventsGet(
...
> {
  ...
  const path = pathToFunc("/api/v1/jobs/batch/predictions/{job_id}/events")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID:
      "stream_batch_predictions_events_api_v1_jobs_batch_predictions__job_id__events_get",
    oAuth2Scopes: null,
